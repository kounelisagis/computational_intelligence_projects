...
class Net(nn.Module):
  ...
  def __init__(self, input_layer_size, hidden_layer1_size, hidden_layer2_size, output_layer_size):
    ...
    self.fc1 = nn.Linear(input_layer_size, hidden_layer1_size)
    self.fc2 = nn.Linear(hidden_layer1_size, hidden_layer2_size)
    self.fc3 = nn.Linear(hidden_layer2_size, output_layer_size)
...
def train_nn(train_vectors, train_labels, test_vectors, test_labels, vocab_size):
    ...
    # Generate the model
    model = Net(input_layer_size=vocab_size, hidden_layer1_size=int((vocab_size+20)/2), hidden_layer2_size = int((vocab_size+20)), output_layer_size=20).to(device)
